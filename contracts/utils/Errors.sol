...
library Errors {
  ...
  string public constant DELEVERAGE_VARIABLE_DEBT_SPECIFIED_EXCEEDS_OWNED =
    "E13";
  string public constant DELEVERAGE_STABLE_DEBT_SPECIFIED_EXCEEDS_OWNED = "E14";
  string public constant OPS_FLASH_LOAN_FEE_NOT_ENOUGH = "E15";
  string public constant OPS_NOT_ABLE_TO_EXCHANGE_BY_SPECIFIED_SLIPPAGE = "E16";
  string public constant MATH_MULTIPLICATION_OVERFLOW = "E17";
  string public constant MATH_ADDITION_OVERFLOW = "E18";
  string public constant MATH_DIVISION_BY_ZERO = "E19";
  string public constant CONTRACT_FALLBACK_NOT_ALLOWED = "E20";
  string public constant CONTRACT_ONLY_CALLED_BY_LENDING_POOL = "E21";
}
